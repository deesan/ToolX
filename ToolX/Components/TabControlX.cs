...
namespace ToolX.Components
{
    public class TabControlX : System.Windows.Forms.TabControl
    {
        ...
        public Color Activforecolor = Color.Navy;
        public Color NonactiveForeColor = Color.Black;
        ...
        public Color ActivTextColor
        {
            get { return Activforecolor; }
            set { Activforecolor = value; Invalidate(); }
        }

        public Color NonActivTextColor
        {
            get { return NonactiveForeColor; }
            set { NonactiveForeColor = value; Invalidate(); }
        }
        ...
        public TabControlX()
        {
            ...
            this.Padding = new System.Drawing.Point(22, 5);
        }
        ...
        protected override void OnDrawItem(DrawItemEventArgs e)
        {
            ...
            if (this.SelectedTab == this.TabPages[e.Index])
            {
                ...
                e.Graphics.DrawString(this.TabPages[e.Index].Text, this.Font, new SolidBrush(Activforecolor), paddedBounds);

                Point pad = this.Padding;

                //drawing close button to tab items
                e.Graphics.DrawString("X", new Font("Arial", 11, FontStyle.Regular), new SolidBrush(closebuttoncolor), e.Bounds.Right + 1 - 20, e.Bounds.Top + pad.Y - 0);
            ...
            else
            {
                ...
                Rectangle paddedBounds = e.Bounds;
                paddedBounds.Inflate(-5, -4);
                e.Graphics.DrawString(this.TabPages[e.Index].Text, this.Font, new SolidBrush(NonactiveForeColor), paddedBounds);
            }
            ...
            ////drawing close button to tab items
            //e.Graphics.DrawString("X", new Font("Segoe UI", 10, FontStyle.Bold), new SolidBrush(closebuttoncolor), e.Bounds.Right + 1 - 18, e.Bounds.Top + pad.Y - 2);
            //e.DrawFocusRectangle();
        }
